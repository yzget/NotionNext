...
const BLOG = {
  ...
  THEME: process.env.NEXT_PUBLIC_THEME || 'hexo',//'simple', // 当前主题，在themes文件夹下可找到所有支持的主题；主题名称就是文件夹名，例如 claude,endspace,example,fukasawa,fuwari,gitbook,heo,hexo,landing,matery,medium,next,nobelium,plog,simple
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '蝴蝶飞', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个网络搬运工🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://ntntblog.mll.cc.cd/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '蝴蝶飞, 博客', // 网站关键词 英文逗号隔开
  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || 'https://img.koa.cc.cd/file/1782737015759_hudiefei.png', // blog favicon 配置, 默认使用 /public/favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png
  ...
  GREETING_WORDS:
    ...
    '我不是喜歡長篇大論的創作者，而是一個重新審視網路衝浪運動員和實用工具收集癖的人,欢迎来到我的博客🎉',
